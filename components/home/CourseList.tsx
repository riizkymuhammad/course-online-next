...
export default function CourseList({
  ...
  const visibleCourses = filteredCourses.slice(0, MAX_VISIBLE_COURSES);
  const hasMoreCourses = filteredCourses.length > MAX_VISIBLE_COURSES;
